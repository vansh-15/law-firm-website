...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F5F1E8] text-[#2B2118]">
      ...
      {/* DISCLAIMER */}
      {!accepted && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#2B2118]/95 px-5 py-8">

          <div className="w-full max-w-3xl bg-[#F5F1E8] shadow-2xl">

            {/* DISCLAIMER HEADER */}
            <div className="border-b border-[#D8C9B5] px-7 py-6 sm:px-10">

              <div className="mb-5 flex items-center gap-4">

                <div className="flex h-12 w-12 items-center justify-center bg-[#A65D45] text-xl font-bold text-white">
                  B
                </div>

                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.25em] text-[#A65D45]">
                    Bharat Law Chambers
                  </p>

                  <p className="mt-1 text-xs uppercase tracking-[0.18em] text-[#68705B]">
                    Legal Disclaimer
                  </p>
                </div>
              ...
              <h1 className="font-serif text-3xl leading-tight text-[#2B2118] sm:text-4xl">
                Disclaimer
              </h1>
            ...
            {/* DISCLAIMER CONTENT */}
            <div className="max-h-[55vh] overflow-y-auto px-7 py-7 sm:px-10">

              <div className="space-y-5 text-sm leading-7 text-[#2B2118]/75">

                <p>
                  The Bar Council of India does not permit advertisement or
                  solicitation by advocates in any form or manner. By accessing
                  this website, you acknowledge that you are seeking information
                  relating to Bharat Law Chambers on your own accord and that
                  there has been no solicitation, invitation or inducement of
                  any sort whatsoever.
                </p>
                ...
                <p>
                  ...
                  legal advice or as creating an advocate-client relationship
                  between Bharat Law Chambers and any visitor to this website.
                </p>

                <p>
                  The content of this website may not reflect the most current
                  legal developments and should not be relied upon as a
                  substitute for professional legal advice.
                </p>

                <p>
                  Accessing or using this website does not create an
                  advocate-client relationship. You should consult a qualified
                  legal professional for advice concerning your individual
                  circumstances.
                </p>
            ...
            {/* DISCLAIMER FOOTER */}
            <div className="border-t border-[#D8C9B5] px-7 py-6 sm:px-10">

              <p className="mb-5 text-xs leading-5 text-[#68705B]">
                By clicking &quot;I Accept&quot;, you acknowledge that you have
                read and understood the above disclaimer.
              </p>

              <button
                onClick={() => setAccepted(true)}
                className="w-full bg-[#A65D45] px-6 py-4 text-sm font-bold uppercase tracking-[0.18em] text-white transition hover:bg-[#2B2118]"
              >
                I Accept
              </button>
          ...
          <div>
            ...
            <div className="mt-10 grid gap-8 text-[15px] leading-7 text-[#2B2118]/70 md:grid-cols-2">
              ...
              <p>
                ...
                identifying the legal position and pursuing a considered course
                of action.
              </p>
      ...
      >
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <p className="max-w-[300px] text-sm leading-6 text-[#2B2118]/60">
            A considered range of legal services for individuals, families and
            businesses.
          </p>
      ...
      <footer className="bg-[#2B2118] text-[#F5F1E8]">
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-16 lg:px-10">
          ...
          <div className="mt-16 flex flex-col justify-between gap-4 border-t border-[#F5F1E8]/10 pt-6 text-[9px] uppercase tracking-[0.18em] text-[#F5F1E8]/35 md:flex-row">
            ...
            <p>
              © 2026 Bharat Law Chambers. All rights reserved.
            </p>
